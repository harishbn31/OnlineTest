...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { ans: @answer.ans, question_id: @answer.question_id } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { ans: @answer.ans, question_id: @answer.question_id } }
